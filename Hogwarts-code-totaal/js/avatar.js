...
class SecondaryButton {
  ...
  constructor(placeToRender) {
    ...
    this.buttonElement.classList = 'Secondary__Button';
    this.buttonElement.textContent = 'Customizer';
...
class App {
  ...
  createButtons = () => {
    const proceedButton = new Button(this.placeToRender);
    proceedButton.addClickEventListener('quests.html');

    const secondaryButton = new SecondaryButton(this.placeToRender);
    secondaryButton.addClickEventListener('custom-av.html');
  };
